...
const Layout2 = function () {
    return <Grid container margin={.1}>
        ...
        <Grid container item sx={{ lineHeight: 2, marginTop: 2, marginLeft: 2.1 }}>
            ...
            <Grid item width={80} sx={{ background: "#C7C7C7", color: "#4D4D4D", textAlign: "center", borderRadius: "8px", marginLeft: "5px" }}>Debates</Grid>
            <Grid item width={80} sx={{ background: "#C7C7C7", color: "#4D4D4D", textAlign: "center", borderRadius: "8px", marginLeft: "5px" }}>Musica indie</Grid>
            <Grid item width={80} sx={{ background: "#C7C7C7", color: "#4D4D4D", textAlign: "center", borderRadius: "8px", marginLeft: "5px" }}>Esportes de combate</Grid>
            <Grid item width={80} sx={{ background: "#C7C7C7", color: "#4D4D4D", textAlign: "center", borderRadius: "8px", marginLeft: "5px" }}>Musica New age</Grid>
            <Grid item width={80} sx={{ background: "#C7C7C7", color: "#4D4D4D", textAlign: "center", borderRadius: "8px", marginLeft: "5px" }}>Carros</Grid>
